  ...
  initialize: function () {
    ...
    function setInitialWidth () {
      if (chart.base.attr('width')) {
        ...
        return parseInt(getComputedStyle(chart.base.node().parentNode).width) - chart._margin.left - chart._margin.right;
      }
    }
    ...
    function setInitialHeight() {
      if (chart.base.attr('height')) {
        ...
        return parseInt(getComputedStyle(chart.base.node().parentNode).height) - chart._margin.top - chart._margin.bottom;
      }
    }

    d3.select(window).on('resize', function() {     
      chart.width(parseInt(getComputedStyle(chart.base.node().parentNode).width) - chart._margin.left - chart._margin.right);
      chart.height(parseInt(getComputedStyle(chart.base.node().parentNode).height) - chart._margin.top - chart._margin.bottom);
    }); 
