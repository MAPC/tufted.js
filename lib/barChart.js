d3.chart("BaseChart").extend("BarChart", {
  ...
  initialize: function() {
    ...
    chart.on('change:width', function(newWidth) {
      ...
      chart.areas.xAxisLayer.call(chart.areas.xAxis)            
          .selectAll("text")
    ...
    d3.select(window).on("resize.bar", function() {
    ...
    chart.layer('bars', chart.layers.bars, {
      ...
      dataBind: function(data) {
        ...
        chart.areas.xAxis = d3.svg.axis()
          .scale(chart.xScale)
          .orient("bottom");

        if (chart._tickValues.length > 0) {
          chart.areas.xAxis.tickValues(chart._tickValues);
        }

        chart.areas.xAxisLayer
          .attr("transform", "translate(0," + chart.height() + ")")
              .call(chart.areas.xAxis)
            .selectAll("text")
              .style("font-family", chart.font)
              .style("font-size", chart.font_size)
